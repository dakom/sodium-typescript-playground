...
const appBackgroundColor = 0xF0EAD2;
...
export class Main {
    ...
    public static Init() {
        //SETUP DISPLAY
        this.app = new PIXI.Application(CanvasWidth, CanvasHeight, { backgroundColor: appBackgroundColor }); //preserveDrawingBuffer for saving images
        document.body.appendChild(this.app.view);
        window.onresize = () => this.ScaleToWindow(this.app.view, pageBackgroundColor);
